      ...
      <header className={`header`}>
        <div className="inr backdrop-blur-sm">
          <div className="ldt">
            ...
            { isActive('user') ? 
              <>
                <button onClick={() => router.back()} type="button" className="bt"><i><FontAwesomeIcon icon={["fas", "arrow-left"]} /></i><b>GoBack</b></button>
              </>
              :
              <h1 className="logo">
          ...
          <div className="rdt">
            {/* {pathname} */}
            <Link href={'/user/login'} className="bt gnb"><i><FontAwesomeIcon icon={["fas", "bars"]} /></i><b>Menu</b></Link>
          </div>
        </div>
      </header>
    </>
