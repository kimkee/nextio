...
export default function Person() {
  ...
  <>
    ...
    <article onWheel={handleWheel} className={`pop-layer c popup person fixed left-0 top-0 bottom-0 right-0 flex justify-center pr-(--scrPad) open backdrop-blur-md `}>
      ...
      `}>
        <div ref={pctRef} onScroll={scrollEvent} className="pct h-full max-h-[calc(100dvh-0px)] overflow-y-auto scrollbar-hidden bg-linear-to-b from-black/10 via-background to-background">
